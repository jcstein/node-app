...
click [here](https://github.com/jcstein/node-app/releases/download/quasar_v0.2.0-alpha_CN-v0.11.0-rc7_Arabica/quasar.dmg) to download the latest release for macOS 13.1+
