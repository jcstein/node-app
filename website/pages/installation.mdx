...
`System Preferences > Privacy & Security > Security` and select `Open Anyway`

<br />

<img width="427" alt="open-anyway" src="/open-anyway.png" />

i have an open [ticket](https://github.com/jcstein/node-app/issues/36) to fix this on github
